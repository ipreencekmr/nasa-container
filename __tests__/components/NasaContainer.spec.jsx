...
import {
  NasaContainer, mapDispatchToProps, mapStateToProps, loadModuleData,
} from '../../src/components/NasaContainer';
...
describe('NasaContainer should render as expected', () => {
  it('module should render correct JSX', () => {
    ...
    const renderedModule = shallow(<NasaContainer {...props} />);
  ...
  describe('mapDispatchToProps', () => {
    it('should update the browser locale and then reload the language pack', async () => {
      ...
      expect(mockDispatch).toHaveBeenNthCalledWith(2, 'I am loading the language pack for nasa-container and my fallback locale is en-US');
    });
  });
  ...
  describe('loadModuleData', () => {
    ...
    it('should load language pack for nasa-container module ', async () => {
      const langPackAsyncState = await loadModuleData({ store: fakeStore });
      expect(langPackAsyncState).toBe('I am loading the language pack for nasa-container and my fallback locale is en-US');
